...
type Config struct {
	...
	// Debug indicates whether the client is running in debug mode.
	Debug bool
	...
	// Docker is responsible for configuring access to Docker registy.
	Docker configurator.Configurator
	// Helm is responsible for configuring access to Helm repository.
